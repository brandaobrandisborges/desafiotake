...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public class Startup
    {
        ...
        private const string API_GIT_BASEURL = "GitHubAppSettings:BaseUrl";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var url = Configuration.GetSection(API_GIT_BASEURL);
            services.AddSingleton(RestClient.For<IRepositoriesServices>(url.Value)) ;
